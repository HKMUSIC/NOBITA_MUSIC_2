...
BOT_USERNAME = getenv("BOT_USERNAME" , "Music_promaxbot")
BOT_NAME = getenv("BOT_NAME" , "𝗘𝗧𝗘𝗥𝗡𝗔𝗟 Mυʂιƈ ♫♪")
ASSUSERNAME = getenv("ASSUSERNAME" , "EXTERNAL_MUSIC_ASSISTANT")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/HKMUSIC/NOBITA_MUSIC_2",)
